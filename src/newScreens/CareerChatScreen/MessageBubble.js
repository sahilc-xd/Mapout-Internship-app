...
const MessageBubble = ({ message, direction }) => {
    if(direction === 'outgoing') {
        return(
            <View style={{ alignItems:'flex-end', marginVertical:5, marginLeft:20 }}>
                <View style={{ backgroundColor: '#D2FFBE', borderTopLeftRadius:10, borderBottomRightRadius:10, borderBottomLeftRadius:10, paddingVertical:10, paddingHorizontal:15 }}>
        ...
        return(
            <View style={{ alignItems:'flex-start', marginVertical:5, marginRight:20 }}>
                <View style={{ backgroundColor: '#EFFFFF', borderTopRightRadius:10, borderBottomRightRadius:10, borderBottomLeftRadius:10, paddingVertical:10, paddingHorizontal:15 }}>
                    <Text>{message.body}</Text>
                </View>
            </View>
        )
